...
class MockCourse:
    def __init__(
        self, title="Test Course", instructor="Test Instructor", course_link="https://example.com"
    ):
        self.title = title
...
class DocumentProcessor:
    def __init__(self, chunk_size=800, chunk_overlap=100):
        ...
        print(
            f"🔧 Mock document processor created with chunk_size={chunk_size}, chunk_overlap={chunk_overlap}"
        )
