...
class Course:
    """Mock Course class"""
    def __init__(self, title: str, course_link: Optional[str] = None,
                 instructor: Optional[str] = None, lessons: Optional[List] = None):
        self.title = title
...
class CourseChunk:
    ...
    def __init__(self, content: str, course_title: str,
                 lesson_number: Optional[int] = None, chunk_index: int = 0):
